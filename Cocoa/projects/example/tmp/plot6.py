...
#DELETE TMP FILES
subprocess.Popen("rm .VM_P6_TMP[0-9].*", shell=True, cwd=".")
...
parameter = [u'10omegach2',u'1e9As',u'10ns',u'100omegabh2',u'H0',u'theta_MC_100',u'logA',u'tau']
chaindir=r'.'

root_chains = ('EXAMPLE_MCMC5','EXAMPLE_MCMC5_THIN')
...
param_3d = None
g.triangle_plot(['.VM_P6_TMP1','.VM_P6_TMP2'],parameter,
plot_3d_with_param=param_3d,line_args=[
{'lw': 1.0,'ls': 'solid', 'color':'royalblue'},
{'lw': 1.4,'ls': 'solid', 'color':'firebrick'},
{'lw': 1.6,'ls': 'dashed', 'color':'black'}],
contour_colors=['royalblue','firebrick','black'],
filled=True,shaded=False,
legend_labels=['SPT TEEE','SPT TEEE THIN',],legend_loc=(0.525,0.765),
imax_shaded=0)
g.export()
