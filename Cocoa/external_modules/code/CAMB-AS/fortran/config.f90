    ...
    logical :: DebugMsgs =.true. !Set to true to view progress and timing

    logical, parameter :: DebugEvolution = .true. !Set to true to do all the evolution for all k
    ...
    real(dl), parameter :: tol=1.0d-3 !KZ: try a larger tolerance
