    ...
    subroutine TDarkEnergyFluid_PerturbedStressEnergy(this, dgrhoe, dgqe, dgpie, sigma_ppf, &!KZ-edit : add dgpie
        a, dgq, dgrho, grho, grhov_t, w, gpres_noDE, etak, adotoa, k, kf1, ay, ayprime, w_ix, &
        grhor_t, grhog_t, pir, pig, pirdot, pigdot, grhonu_t, pinudot, gpnu_t, pinu) !KZ-edit
    class(TDarkEnergyFluid), intent(inout) :: this
    real(dl), intent(out) :: dgrhoe, dgqe, dgpie,sigma_ppf !KZ-edit : add dgpie
    real(dl), intent(in) ::  a, dgq, dgrho, grho, grhov_t, w, gpres_noDE, etak, adotoa, k, kf1
    real(dl), intent(in) :: grhor_t, grhog_t, pir, pig, pirdot, pigdot, grhonu_t, pinudot, gpnu_t, pinu !KZ-edit
    ...
    subroutine TAxionEffectiveFluid_PerturbedStressEnergy(this, dgrhoe, dgqe, dgpie,sigma_ppf, & !KZ-edit : add dgpie
        a, dgq, dgrho, grho, grhov_t, w, gpres_noDE, etak, adotoa, k, kf1, ay, ayprime, w_ix, &
        grhor_t, grhog_t, pir, pig, pirdot, pigdot, grhonu_t, pinudot, gpnu_t, pinu) !KZ-edit
    class(TAxionEffectiveFluid), intent(inout) :: this
    real(dl), intent(out) :: dgrhoe, dgqe, dgpie, sigma_ppf !KZ-edit : add dgpie
    real(dl), intent(in) :: a, dgq, dgrho, grho, grhov_t, w, gpres_noDE, etak, adotoa, k, kf1
    real(dl), intent(in) :: grhor_t, grhog_t, pir, pig, pirdot, pigdot, grhonu_t, pinudot, gpnu_t, pinu
    real(dl), intent(in) :: ay(*)
    real(dl), intent(inout) :: ayprime(*)
    integer, intent(in) :: w_ix
